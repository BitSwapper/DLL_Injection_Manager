...
using Injector64.Core; // To call Injector64.dll's core logic

namespace Injector64MiddleMan
{
    internal class Program
    {
        static int Main(string[] args)
        {
            ...
            if(args.Length < 2)
            {
                result = new InjectionResult { Success = false, Message = "Usage: Injector64MiddleMan.exe <PID> <DLL_PATH>", ModuleHandle = 0L };
            ...
            // Call the Injector64 library's core logic
            result = Injector64.Core.InjectorCore.InjectDllInternal(processId, dllPath);
