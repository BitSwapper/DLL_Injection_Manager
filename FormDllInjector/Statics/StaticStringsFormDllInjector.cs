namespace FormDllInjector.Statics;

public static class StaticStringsFormDllInjector
{
    ...
    public static readonly string MsgDllPossiblyLoadedFormat = "The DLL '{0}' may already be loaded in [{1}].{2}{2}Do you want to attempt to inject it again?";
    ...
    public static readonly string StatusErrorGenericFormat = "Error: {0}";
    ...
    public static readonly string StatusDllUnloadedFormat = "DLL may have been unloaded from [{0}] or process terminated.";
