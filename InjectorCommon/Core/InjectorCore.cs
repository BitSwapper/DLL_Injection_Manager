...
internal static class InjectorCore
{
    ...
    internal static InjectionResult InjectDllInternal(int processId, string dllPath)
    {
    ...
    static nint GetLoadLibraryAddress()
    {
        ...
        return NativeMethods.GetProcAddress(kernel32Handle, StaticInjectorStrings.LoadLibraryFunctionName);
    }
}